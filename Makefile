...
SRC_HELPER = helper/get_number_of.c helper/is_type.c helper/get_token_type.c helper/get_next_token_len.c
...
SRC_PARSER = parser/expander.c parser/lexer.c parser/parser.c parser/syntax_error.c
